...
set_config_specific_property("OUTPUT_DIRECTORY" "${CMAKE_SOURCE_DIR}/../output.vs${MSVC_TOOLSET_VERSION}/$<$<NOT:$<STREQUAL:${CMAKE_VS_PLATFORM_NAME},Win32>>:/${CMAKE_VS_PLATFORM_NAME}>/${PROPS_CONFIG}")
